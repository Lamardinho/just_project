...
(
    ...
    title varchar(255) not null
        constraint uk_6iifkhmg1bm4skkakx6ix14sj unique
);
...
from orders ord
         INNER join order_details on ord.order_id = order_details.order_id
         INNER join products on order_details.product_id = products.product_id
         INNER join customers on ord.customer_id = customers.customer_id
         INNER join employees on ord.employee_id = employees.employee_id
where ship_country = 'USA';

--========================================  LEFT JOIN / RIGHT JOIN  =====================================================
-- LEFT OUTER JOIN: все которые есть в левой
-- хотим увидеть компании на которых не весят никакие заказы:
...
where order_id is null;
--=============================================  SELF JOIN  ==========================================================
create table if not exists employee_self
(
...
select 'id:' || e.id || ' (' || e.f_name || ' ' || e.l_name || ')'    as employee,
       'id:' || me.id || ' (' || me.f_name || ' ' || me.l_name || ')' as manager
from employee_self e
         LEFT JOIN employee_self me on me.id = e.manager_id;
--=============================================  CLEAN CODE  ==========================================================
-- using если наименования столбцов (например id) одинаковые в обеих табличках
select contact_name,
       company_name,
       phone,
       first_name,
